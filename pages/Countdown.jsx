    ...
    <div className="w-full">
      <div className="w-full h-[30vh] lg:h-[40vh] relative">
        ...
        <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-[#f5eded] z-20 p-2">
          <h2 className="py-2">New Year Countdown</h2>
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4">
          ...
          <p className="py-2">
            ...
            used HTML, CSS and basic JavaScript. This project was maded when I
            was learning more about JavaScript Date functions.
          </p>
          <button className="px-8 py-2 mt-4 mr-8">
            <a
              href="https://newyear-countdown-theta.vercel.app"
              target="_blank"
              rel="noreferrer"
            >
              Demo
          ...
          <button className="px-8 py-2 mt-4 mr-8">
            <a
              href="https://github.com/LucianoCerullo77/newyearCountdown"
              target="_blank"
              rel="noreferrer"
            >
              Repository
