    ...
    <div className="w-full">
      <div className="w-full h-[30vh] lg:h-[40vh] relative">
        ...
        <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-[#f5eded] z-20 p-2">
          <h2 className="py-2">React To Do List</h2>
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4">
          ...
          <p className="py-2">
            This is a simple React To Do list, maded to test my level at coding,
            there's not much to say, it works perfectly and it was one of my
            first projects.
          </p>
          <button className="px-8 py-2 mt-4 mr-8">
            <a href="https://reacttodo-one.vercel.app" target="_blank">
              Demo
            </a>
          </button>
          <button className="px-8 py-2 mt-4 mr-8">
